...
/** 
 * Basic interface for endgame position controllers controllers
 * 
 * Outlines required functions and variables all endgame position controllers have to make implementing new types
 * of endgame position controllers in the future much simpler
 */
