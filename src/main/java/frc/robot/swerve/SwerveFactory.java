      ...
      MechanismBuilder.edit(steerConfig)
        .absoluteEncoderConfig(
          AbsoluteEncoderBuilder.edit(steerConfig.absoluteEncoderConfig())
            .offset(Rotation2d.fromRotations(0.20727).unaryMinus())
            .build())
        .build(),
      driveConfig,
      wheelCircumference);
  ...
  public static SwerveModule createNorthEastModule(
    ...
    return createModule(
      ...
      MechanismBuilder.edit(steerConfig)
        .absoluteEncoderConfig(
          AbsoluteEncoderBuilder.edit(steerConfig.absoluteEncoderConfig())
            .offset(Rotation2d.fromRotations(0.24685).unaryMinus())
            .build())
        .build(),
      driveConfig,
      wheelCircumference);
  ...
  public static SwerveModule createSouthEastModule(
    ...
    return createModule(
      ...
      MechanismBuilder.edit(steerConfig)
        .absoluteEncoderConfig(
          AbsoluteEncoderBuilder.edit(steerConfig.absoluteEncoderConfig())
            .offset(Rotation2d.fromRotations(-0.11328).unaryMinus())
            .build())
        .build(),
      driveConfig,
      wheelCircumference);
  ...
  public static SwerveModule createSouthWestModule(
    ...
    return createModule(
      ...
      MechanismBuilder.edit(steerConfig)
        .absoluteEncoderConfig(
          AbsoluteEncoderBuilder.edit(steerConfig.absoluteEncoderConfig())
            .offset(Rotation2d.fromRotations(-0.43606).unaryMinus())
            .build())
        .build(),
      driveConfig,
      wheelCircumference);
