      ...
      MechanismBuilder.edit(steerConfig)
        .absoluteEncoderConfig(
          AbsoluteEncoderBuilder.edit(steerConfig.absoluteEncoderConfig())
            .offset(Rotation2d.fromDegrees(-128.9).unaryMinus())
            .build())
        .build(),
      driveConfig,
      wheelCircumference);
  ...
  public static SwerveModule createNorthEastModule(
    ...
    return createModule(
      ...
      MechanismBuilder.edit(steerConfig)
        .absoluteEncoderConfig(
          AbsoluteEncoderBuilder.edit(steerConfig.absoluteEncoderConfig())
            .offset(Rotation2d.fromDegrees(-70.65).unaryMinus())
            .build())
        .build(),
      driveConfig,
      wheelCircumference);
  ...
  public static SwerveModule createSouthEastModule(
    ...
    return createModule(
      ...
      MechanismBuilder.edit(steerConfig)
        .absoluteEncoderConfig(
          AbsoluteEncoderBuilder.edit(steerConfig.absoluteEncoderConfig())
            .offset(Rotation2d.fromDegrees(-50.185546875).unaryMinus())
            .build())
        .build(),
      driveConfig,
      wheelCircumference);
  ...
  public static SwerveModule createSouthWestModule(
    ...
    return createModule(
      ...
      MechanismBuilder.edit(steerConfig)
        .absoluteEncoderConfig(
          AbsoluteEncoderBuilder.edit(steerConfig.absoluteEncoderConfig())
            .offset(Rotation2d.fromDegrees(158.6).unaryMinus())
            .build())
        .build(),
      driveConfig,
      wheelCircumference);
